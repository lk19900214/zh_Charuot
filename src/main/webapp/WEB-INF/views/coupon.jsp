...
<!DOCTYPE html>
<!-- saved from url=(0074)http://mall.kongzhong.com/MemberController/accountSettings_coupons?state=0 -->
<html>
<head>
    <meta http-equiv="Content-Type">

    <title>我的优惠券-军武游戏商城</title>
    ...
    <div class="userCenter setting">
        <div class="maxW">
            <div class="leftbox">
                <dl class="lnav">
                    ...
                    <dd>
                        ...
                        <a href="./我的优惠券-军武游戏商城_files/我的优惠券-军武游戏商城.html" class="curr">我的优惠券</a>
                    </dd>
                    <dd class="online">
            ...
            <div class="right rightbox">
                <div class="cTab clearfloat">
                    <a href="./我的优惠券-军武游戏商城_files/我的优惠券-军武游戏商城.html" class="curr">未使用（0）</a>
                    <a href="http://mall.kongzhong.com/MemberController/accountSettings_coupons?state=1">已使用（0）</a>
                    <a href="http://mall.kongzhong.com/MemberController/accountSettings_coupons?state=2">已失效（0）</a>
                </div>
                <div class="noneL"><p class="center">暂时没有优惠券哦~</p></div>
            </div>
        </div>
    </div>
    <!--账户设置 结束-->
...
<div id="footer">
    <div class="maxW">
        ...
        <div class="copyright clearfloat">
            <a href="http://mall.kongzhong.com/MemberController/accountSettings_coupons?state=0#" target="_blank"><img src="../../img/zhan.png" width="117" height="50"></a>
            <a href="http://mall.kongzhong.com/MemberController/accountSettings_coupons?state=0#" target="_blank"><img src="../../img/wargaming.png" width="105" height="50"></a>
...
<script type="text/javascript">
    ...
    seajs.use('modules/member/accountSettings_coupons', function(app) {
    });
</script>
<span style="display:none"><script src="./我的优惠券-军武游戏商城_files/z_stat.php" language="JavaScript"></script><script src="./我的优惠券-军武游戏商城_files/core.php" charset="utf-8" type="text/javascript"></script><a href="http://www.cnzz.com/stat/website.php?web_id=1256834993" target="_blank" title="站长统计">站长统计</a></span>
